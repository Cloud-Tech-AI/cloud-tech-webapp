...
const featuredPodcast = {
  ...
  description: 'Join us as we explore the latest trends in serverless architecture with industry expert John Smith.',
  duration: '45:30',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our latest podcast episodes and blog articles covering the most important topics in cloud computing.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="relative mb-4">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 rounded-lg flex items-center justify-center">
                <div className="bg-white bg-opacity-90 rounded-full p-4">
                  <FiPlay className="h-8 w-8 text-primary-600" />
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              <FiBookOpen className="h-5 w-5 text-secondary-600" />
